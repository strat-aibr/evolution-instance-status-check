 ...
 * @returns {Promise<{ connected: boolean, qrcode?: string, code?: string, pairingCode?: string, status?: string }>}
 */
  ...
  try {
    ...
    if (randomStatus) {
      ...
      return { 
        connected: false,
        status: "disconnected",
        qrcode: "... (truncated for brevity)",
